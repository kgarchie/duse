...
ALTER TABLE `inventory` ADD CONSTRAINT `inventory_edited_by_users_user_id_fk` FOREIGN KEY (`edited_by`) REFERENCES `users`(`user_id`) ON DELETE no action ON UPDATE no action;
